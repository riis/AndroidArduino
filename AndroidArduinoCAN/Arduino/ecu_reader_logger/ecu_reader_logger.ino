...
void setup() {
  ...
  Serial.print("D:CAN  U:GPS");
  Serial.write(COMMAND);
  Serial.write(LINE1); 
  Serial.print("L:SD   R:LOG");
...
void loop() {
  ...
  {
    Serial.write(COMMAND);                   /* Move LCD cursor to line 0 */
    Serial.write(LINE0);
    Serial.print(buffer);                         /* Display data on LCD */
  ...
  {
    Serial.write(COMMAND);
    Serial.write(LINE1);                     /* Move LCD cursor to line 1 */
    Serial.print(buffer);
...
void logging(void)
{
  ...
  delay(500);
  clear_lcd(); 
  Serial.print("Press J/S click");  
  Serial.write(COMMAND);
  Serial.write(LINE1);                     /* Move LCD cursor to line 1 */
   Serial.print("to Stop"); 
...
void gps_test(void){
  ...
  if (strncmp(buffer, "$GPRMC",6) == 0) {
    ...
    Serial.print(latitude/1000000, DEC); Serial.write(0xDF); Serial.print(' ');
    Serial.print((latitude/10000)%100, DEC); Serial.print('\''); //Serial.print(' ');
    Serial.print((latitude%10000)*6/1000, DEC); Serial.print('.');
    ...
    Serial.print(longitude/1000000, DEC); Serial.write(0xDF); Serial.print(' ');
    Serial.print((longitude/10000)%100, DEC); Serial.print('\''); //Serial.print(' ');
    Serial.print((longitude%10000)*6/1000, DEC); Serial.print('.');
